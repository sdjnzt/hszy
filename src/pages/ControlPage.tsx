...
const ControlPage: React.FC = () => {
  const [controlRecords, setControlRecords] = useState<ControlRecord[]>([
    {
      ...
      status: '布控中',
      createTime: '2025-08-31 15:30:00',
      createBy: '王安全',
      lastAlertTime: '2025-08-01 13:45:00',
      alertCount: 2,
      lastLocation: '井下采掘区域入口',
      lastSeenTime: '2025-08-01 14:30:00',
      alertHistory: [
        {
          id: 'A001',
          targetId: 'MK2024001',
    ...
    },
    {
      ...
      endTime: '2025-08-30 18:00:00',
      status: '布控中',
      createTime: '2025-08-31 16:20:00',
      createBy: '李管理',
      lastAlertTime: '2025-08-01 09:15:00',
      alertCount: 1,
      lastLocation: '矿区主干道',
    ...
    },
    {
      ...
      status: '布控中',
      createTime: '2025-08-14 10:30:00',
      createBy: '张主管',
      lastAlertTime: '2025-08-01 11:20:00',
      alertCount: 3,
      lastLocation: '变电所控制室',
    ...
    },
    {
      ...
      endTime: '2025-08-30 23:59:59',
      status: '布控中',
      createTime: '2025-08-31 18:00:00',
      createBy: '赵管理',
      alertCount: 2,
      lastLocation: '应急通道',
      lastSeenTime: '2025-08-01 15:45:00',
      alertHistory: [
        {
          id: 'A006',
          targetId: 'MKV2024002',
    ...
    },
    {
      ...
      reason: '考勤管理',
      startTime: '2025-08-01 08:00:00',
      endTime: '2025-08-30 17:30:00',
      status: '布控中',
      createTime: '2025-08-31 17:00:00',
      createBy: '刘主管',
      alertCount: 1,
      lastLocation: '井下3号巷道',
    ...
    },
    {
      ...
      alertCount: 0,
      lastLocation: '物资仓库',
      lastSeenTime: '2025-08-31 23:45:00',
      alertHistory: []
    },
    {
      id: 'C007',
      ...
      rule: '区域进出管控',
      reason: '安全管理',
      startTime: '2025-08-01 07:00:00',
      endTime: '2025-08-30 19:00:00',
      status: '布控中',
      createTime: '2025-08-31 16:00:00',
      createBy: '马主管',
      alertCount: 1,
      lastLocation: '主通风机房',
    ...
    },
    {
      ...
      endTime: '2025-08-30 23:59:59',
      status: '布控中',
      createTime: '2025-08-31 17:30:00',
      createBy: '王管理',
      alertCount: 2,
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      ...
      const alertLocations = ['东区安全通道', '南门停车场', '西区宿舍楼', '北区办公楼'];
