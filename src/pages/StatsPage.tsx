...
const dormitoryData = {
  buildings: [
    { id: '1号楼', name: '1号宿舍楼', capacity: 120, occupied: 108, floors: 6 },
    { id: '2号楼', name: '2号宿舍楼', capacity: 120, occupied: 95, floors: 6 },
    { id: '3号楼', name: '3号宿舍楼', capacity: 100, occupied: 88, floors: 5 },
    { id: '4号楼', name: '4号宿舍楼', capacity: 80, occupied: 72, floors: 4 },
  ],
  departments: [
...
const StatsPage: React.FC = () => {
  ...
  const cameraStats = {
    ...
    dormitory: cameras.filter(c => c.area === 'dormitory').length,
        ...
        <Col span={6}>
          <Card>
            ...
            <div style={{ fontSize: '12px', marginTop: 8, color: '#666' }}>
              已入住 {dormitoryStats.totalOccupied} / 总床位 {dormitoryStats.totalCapacity}
            </div>
          </Card>
        </Col>
        <Col span={6}>
