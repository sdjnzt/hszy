...
export interface Camera {
  ...
  longitude: number;
  latitude: number;
  buildingNumber?: string; // 宿舍楼号
  floor?: number; // 楼层
  area: 'dormitory' | 'entrance' | 'canteen' | 'parking' | 'recreation' | 'safety'; // 区域类型
...
export const alertEvents: AlertEvent[] = [
  {
    ...
    status: '未处理',
    description: '检测到深夜时间有人员在宿舍楼大厅聚集，疑似违规活动。',
  },
  {
    id: 'alert002',
    type: '烟雾报警',
    ...
    cameraId: 'cam002',
    status: '处理中',
    description: '检测到2号宿舍楼走廊有烟雾，可能有人在宿舍内吸烟。',
    handledBy: '张安全',
    handleTime: '2025-08-01 09:18:00',
  },
  {
    id: 'alert003',
    type: '非法入侵',
...
export const persons: Person[] = [
  // 采掘部人员 (89人)
  {
    ...
    lastLocation: '1号宿舍楼一楼大厅',
    lastSeenTime: '2025-08-01 08:30:00',
    workShift: '白班',
  ...
  },
  {
    ...
    lastSeenTime: '2025-08-01 07:20:00',
    workShift: '夜班',
    emergencyContact: '李慧',
    emergencyPhone: '139****0002',
    tags: ['技术员工'],
  },
  {
    id: 'person003',
    ...
    lastLocation: '职工食堂内部',
    lastSeenTime: '2025-08-01 10:15:00',
    workShift: '白班',
    emergencyContact: '王大明',
    emergencyPhone: '139****0003',
    tags: ['后勤人员'],
  },
  {
    id: 'person004',
    ...
    lastSeenTime: '2025-08-01 09:45:00',
    workShift: '倒班',
  ...
  },
  {
    ...
    lastLocation: '宿舍楼门口',
    lastSeenTime: '2025-08-01 11:20:00',
    workShift: '白班',
    emergencyContact: '马丽',
  ...
  },
  {
    ...
    lastLocation: '安全通道入口',
    lastSeenTime: '2025-08-01 12:00:00',
    workShift: '夜班',
    emergencyContact: '陈霞',
  ...
  },
  {
    ...
    lastSeenTime: '2025-08-01 08:15:00',
    workShift: '倒班',
    emergencyContact: '周美',
  ...
  },
  {
    ...
    lastLocation: '食堂',
    lastSeenTime: '2025-08-01 12:30:00',
    workShift: '白班',
    emergencyContact: '孙丽',
  ...
  },
  {
    ...
    lastLocation: '宿舍楼管理处',
    lastSeenTime: '2025-08-01 07:50:00',
    workShift: '倒班',
  ...
  },
  {
    ...
    lastLocation: '停车场',
    lastSeenTime: '2025-08-01 09:10:00',
    workShift: '夜班',
    emergencyContact: '李红',
  ...
  },
  {
    ...
    lastSeenTime: '2025-08-01 13:45:00',
    workShift: '白班',
    emergencyContact: '王芳',
  ...
  },
  {
    ...
    lastLocation: '活动中心',
    lastSeenTime: '2025-08-01 20:30:00',
    workShift: '倒班',
    emergencyContact: '杨梅',
  ...
  // 机电部人员 (67人)
  {
    ...
    lastSeenTime: '2025-08-01 08:25:00',
    workShift: '白班',
    emergencyContact: '高丽',
  ...
  },
  {
    ...
    lastLocation: '职工食堂',
    lastSeenTime: '2025-08-01 12:15:00',
    workShift: '夜班',
    emergencyContact: '许娟',
  ...
  },
  {
    ...
    lastSeenTime: '2025-08-01 07:40:00',
    workShift: '倒班',
    emergencyContact: '郭静',
  ...
  },
  {
    ...
    lastLocation: '出入口监控点',
    lastSeenTime: '2025-08-01 09:55:00',
    workShift: '白班',
    emergencyContact: '田芳',
  ...
  },
  {
    ...
    lastSeenTime: '2025-08-01 14:20:00',
    workShift: '夜班',
    emergencyContact: '黄丽',
  ...
  },
  {
    ...
    lastLocation: '宿舍楼管理处',
    lastSeenTime: '2025-08-01 10:30:00',
    workShift: '倒班',
    emergencyContact: '彭雪',
  ...
  // 安全部人员 (45人)
  {
    ...
    lastSeenTime: '2025-08-01 08:05:00',
    workShift: '白班',
    emergencyContact: '石娟',
  ...
  },
  {
    ...
    lastLocation: '安全通道',
    lastSeenTime: '2025-08-01 11:40:00',
    workShift: '夜班',
    emergencyContact: '余莲',
  ...
  },
  {
    ...
    lastLocation: '食堂',
    lastSeenTime: '2025-08-01 12:50:00',
    workShift: '倒班',
    emergencyContact: '段丽',
  ...
  },
  {
    ...
    lastLocation: '活动中心门口',
    lastSeenTime: '2025-08-01 15:25:00',
    workShift: '白班',
    emergencyContact: '邵敏',
  ...
  // 后勤部人员 (34人)
  {
    ...
    lastSeenTime: '2025-08-01 09:30:00',
    workShift: '白班',
    emergencyContact: '刘建',
  ...
  },
  {
    ...
    lastSeenTime: '2025-08-01 16:45:00',
    workShift: '白班',
    emergencyContact: '朱伟',
  ...
  },
  {
    ...
    lastLocation: '洗衣房',
    lastSeenTime: '2025-08-01 14:10:00',
    workShift: '夜班',
    emergencyContact: '胡明',
  ...
  },
  {
    ...
    lastLocation: '仓库区域',
    lastSeenTime: '2025-08-01 11:55:00',
    workShift: '白班',
    emergencyContact: '何强',
  ...
  // 财务部人员 (23人)
  {
    ...
    lastSeenTime: '2025-08-01 17:30:00',
    workShift: '白班',
    emergencyContact: '张军',
  ...
  },
  {
    ...
    lastLocation: '停车场',
    lastSeenTime: '2025-08-01 18:20:00',
    workShift: '白班',
    emergencyContact: '林强',
  ...
  // 管理部人员 (28人)
  {
    ...
    lastLocation: '管理办公室',
    lastSeenTime: '2025-08-01 18:50:00',
    workShift: '白班',
    emergencyContact: '罗丽',
  ...
  },
  {
    ...
    lastLocation: '人事办公室',
    lastSeenTime: '2025-08-01 17:45:00',
    workShift: '白班',
    emergencyContact: '苏芳',
  ...
  },
  {
    ...
    lastSeenTime: '2025-08-01 11:30:00',
    workShift: '倒班',
    emergencyContact: '赵丽华',
  ...
  },
  {
    ...
    lastLocation: '职工活动中心',
    lastSeenTime: '2025-08-01 12:45:00',
    workShift: '白班',
...
export const vehicles: Vehicle[] = [
  // 小轿车样本 (实际120辆)
  {
    ...
    lastSeenTime: '2025-08-01 08:20:00',
    parkingPermit: true,
  ...
  },
  {
    ...
    lastLocation: '停车场A区',
    lastSeenTime: '2025-08-01 07:45:00',
    parkingPermit: true,
  ...
  },
  {
    ...
    lastLocation: '2号宿舍楼附近',
    lastSeenTime: '2025-08-01 09:15:00',
    parkingPermit: true,
  ...
  },
  {
    ...
    lastSeenTime: '2025-08-01 16:30:00',
    parkingPermit: true,
  ...
  },
  {
    ...
    lastLocation: '管理办公区',
    lastSeenTime: '2025-08-01 17:20:00',
    parkingPermit: true,
  ...
  },
  {
    ...
    lastLocation: '安全检查点',
    lastSeenTime: '2025-08-01 14:50:00',
    parkingPermit: true,
    permitExpiry: '2025-12-31',
    tags: ['部门车辆', '安全巡检'],
  },
  ...
  // 临时车辆 (10辆) - 无停车许可
  {
    ...
    lastLocation: '访客停车区',
    lastSeenTime: '2025-08-01 15:30:00',
    parkingPermit: false,
    tags: ['临时车辆', '访客'],
  },
  {
  ...
  },
  {
    ...
    lastLocation: '临时停车位',
    lastSeenTime: '2025-08-01 13:15:00',
    parkingPermit: false,
    tags: ['临时车辆', '检查'],
  },
  {
    ...
    lastLocation: '维修服务区',
    lastSeenTime: '2025-08-01 10:50:00',
    parkingPermit: false,
    tags: ['临时车辆', '维修服务'],
  },
  {
  ...
  },
  {
    ...
    lastLocation: '培训中心',
    lastSeenTime: '2025-08-01 16:10:00',
    parkingPermit: false,
    tags: ['临时车辆', '培训师'],
  },
  {
    ...
    lastLocation: '技术指导区',
    lastSeenTime: '2025-08-01 12:40:00',
    parkingPermit: false,
    tags: ['临时车辆', '技术专家'],
  },
  {
    ...
    lastLocation: '供应商接待区',
    lastSeenTime: '2025-08-01 15:55:00',
    parkingPermit: false,
    tags: ['临时车辆', '供应商'],
  },
];
...
export const accessCards: AccessCard[] = Array(50).fill(null).map((_, index) => {
  ...
  const issueDate = '2025-08-01';
  const expireDate = '2025-01-01';
  
  return {
    id: `card${index + 1}`,
    cardNo,
    cardType: Math.random() > 0.2 ? '员工卡' : (Math.random() > 0.5 ? '访客卡' : '临时卡'),
    status: Math.random() > 0.1 ? '正常' : (Math.random() > 0.5 ? '挂失' : '注销'),
    holder,
    department,
    issueDate,
    expireDate,
    lastAccessTime: '2025-08-18 08:30:00',
...
export const accessRecords: AccessRecord[] = Array(100).fill(null).map((_, index) => {
  ...
  const locations = ['主楼大门', '侧门', '后门', '车库入口', '餐厅通道'];
  ...
  return {
    ...
    accessTime: '2025-08-18 08:30:00',
    location,
...
export const visitors: Visitor[] = Array(50).fill(null).map((_, index) => {
  ...
  return {
    ...
    visitee,
    department,
    plannedStartTime: '2025-08-18 09:00:00',
    plannedEndTime: '2025-08-18 17:00:00',
...
export const maintenanceRecords: MaintenanceRecord[] = Array(50).fill(null).map((_, index) => {
  ...
  return {
    ...
    reportTime: '2025-08-18 09:00:00',
    reporter: generateName(),
    assignee: status !== '待处理' ? generateName() : undefined,
    startTime: status !== '待处理' ? '2025-08-18 10:00:00' : undefined,
    endTime: status === '已完成' || status === '已验收' ? '2025-08-18 11:00:00' : undefined,
...
export const alarmRecords: AlarmRecord[] = Array(30).fill(null).map((_, index) => {
  ...
  return {
    ...
    alarmTime: '2025-08-18 10:00:00',
    status: status as any,
    description: '设备异常报警',
    handler: status !== '未处理' ? generateName() : undefined,
    handleTime: status !== '未处理' ? '2025-08-18 10:30:00' : undefined,
...
export const patrolPoints: PatrolPoint[] = Array(20).fill(null).map((_, index) => {
  ...
  return {
    ...
    qrCode: `QR${index + 1}`,
    status: Math.random() > 0.1 ? '正常' : '异常',
    lastPatrolTime: '2025-08-18 10:00:00',
...
export const patrolTasks: PatrolTask[] = Array(10).fill(null).map((_, index) => {
  ...
  return {
    ...
    department: '安全部',
    planStartTime: '2025-08-18 09:00:00',
    planEndTime: '2025-08-18 11:00:00',
    actualStartTime: status !== '待执行' ? '2025-08-18 09:00:00' : undefined,
    actualEndTime: status === '已完成' ? '2025-08-18 11:00:00' : undefined,
    status: status as any,
    progress,
    pointRecords: route.points.map(pointId => {
      ...
      return {
        ...
        planTime: '2025-08-18 09:00:00',
        actualTime: progress > 50 ? '2025-08-18 09:30:00' : undefined,
